...
class RetrievalTfidf:
    ...
    def retrieve(
        ...
        if isinstance(query_or_dataset, str):
            ...
            print("[query exhaustive search using TF-IDF]\n", query_or_dataset, "\n")
            ...
            total = []
            with timer("query exhaustive search using TF-IDF"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--retrieval_method", metavar="tfidf", type=str, help="")
    ...
    # test single query
    with timer("single query by exhaustive search using TF-IDF"):
        scores, indices = retriever.retrieve(query)

    # test bulk
    with timer("bulk query by exhaustive search using TF-IDF"):
