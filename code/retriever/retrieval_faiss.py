...
class RetrievalFaiss:
    ...
    def retrieve(
        ...
        if isinstance(query_or_dataset, str):
            ...
            print("[query exhaustive search using FAISS]\n", query_or_dataset, "\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--retrieval_method", metavar="faiss", type=str, help="")
    ...
    # test single query
    with timer("single query by exhaustive search using FAISS"):
        scores, indices = retriever.retrieve(query)

    # test bulk
    with timer("bulk query by exhaustive search using FAISS"):
